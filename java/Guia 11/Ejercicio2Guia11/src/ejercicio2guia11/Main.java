...
/**
 * @author Luciano Otegui Realizar el juego de la ruleta rusa de agua en Java.
 * Como muchos saben, el juego se trata de un número de jugadores, que, con un
 * revolver de agua, el cual posee una sola carga de agua, se dispara y se moja.
 * Las clases por hacer del juego son las siguientes: Clase Revolver de agua:
 ...
 * generarán aleatoriamente. Métodos: • llenarRevolver(): le pone los valores de
 * posición actual y de posición del agua. Los valores deben ser aleatorios. •
 ...
 * agua) Clase Jugador: esta clase posee los siguientes atributos: id
 * (representa el número del jugador), nombre (Empezara con Jugador más su ID,
 * “Jugador 1” por ejemplo) y mojado (indica si está mojado o no el jugador). El
 * número de jugadores será decidido por el usuario, pero debe ser entre 1 y 6.
 * Si no está en este rango, por defecto será 6. Métodos: • disparo(Revolver r):
 ...
 * y el método devuelve true, sino false. Clase Juego: esta clase posee los
 * siguientes atributos: Jugadores (conjunto de Jugadores) y Revolver Métodos: •
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int numj = 6;
        System.out.println("Diga cuantos jugadores desean participar");
        numj = sc.nextInt();
