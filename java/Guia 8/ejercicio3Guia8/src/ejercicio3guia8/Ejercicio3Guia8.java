...
import sercicios.Servicios;

/**
 * @author Luciano Otegui Realizar una clase llamada Persona en el paquete de
 * entidades que tengan los siguientes atributos: nombre, edad, sexo (‘H’ para
 * hombre, ‘M’ para mujer, ‘O’ para otro), peso y altura. Si desea añadir algún
 * otro atributo, puede hacerlo. Agregar constructores, getters y setters. En el
 * paquete Servicios crear PersonaServicio con los siguientes 3 métodos: a)
...
//        servicios.esMayorDeEdad(persona, persona.getEdad());
//        servicios.calcularIMC(persona);
//        System.out.println(persona.toString() + persona2.toString() + persona3.toString() + persona4.toString());
