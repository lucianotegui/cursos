...
/**
 * @author Luciano OteguiRealizar una clase llamada Persona en el paquete de
...
public class Servicios {
    ...
    public boolean esMayorDeEdad(Persona persona, int edad) {
        boolean mayor = false;
        if (edad >= 18) {
            mayor = true;
        }
    ...
    public Persona crearPersona() {
        ...
        while (persona.getSexo() != 'H' && persona.getSexo() != 'M' && persona.getSexo() != 'O') {
            System.out.println("El parametro ingresado es incorrecto");
            System.out.println("Ingrese el sexo (H/M/O)");
            persona.setSexo(sc.next().charAt(0));
        }
